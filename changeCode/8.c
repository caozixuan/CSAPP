...
entity_6 [ entity_3 ] ,                             // Tag.BODY
* entity_7 ,       // Tag.BODY
entity_8 [ 100 ] [ 40 ] = { { '0' } } ;          // Tag.BODY
const char entity_9 [ ] = " .,;:!-\n\t" ;      // Tag.BODY
int entity_10 [ 100 ] = { 0 } ,                   // Tag.BODY
entity_11 , entity_12 = 0 ,                       // Tag.BODY
entity_13 = 0 , entity_14 = 0 ,                  // Tag.BODY
entity_15 = 0 ; // Tag.BODY
if ( rand()){                                    // Tag.BODY
strcpy(entity_4, entity_2[1],sizeof(file_name));                   // Tag.STRCPY_SAFE
} else {                                        // Tag.BODY
                                                // Tag.BODY
                                                // Tag.BODY
}                                               // Tag.BODY
